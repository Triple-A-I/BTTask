...
class SearchTasksLoadingState extends TaskState {}

class SearchTasksSuccessState extends TaskState {
  final List<TaskModel> filteredTasks;

  SearchTasksSuccessState({required this.filteredTasks});
}

class SearchTasksEmptyState extends TaskState {}
